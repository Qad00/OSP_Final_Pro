...
def result():
    ...
    if len(prepro_comms) == 0:
	return render_template("result_page.html", errHand="No comments in Korean Language. Please, choose videos with comments in korean language for research." 
    else: 
        # Result data
